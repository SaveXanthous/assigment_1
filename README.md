...
* E Reflection Section
  ...
  * To be honest, I don't understand the advantages of OOP myself.
    When I change the programming language, I change the style and design, but there are the same models. It feels like it's OOP everywhere, but it's not. It's just that sometimes my coding style matches or approaches it.
